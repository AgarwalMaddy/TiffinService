...
export default function Footer() {
  return (
    <footer className="bg-orange-50/50 text-gray-700">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div className="space-y-4">
            <Link href="/" className="text-2xl font-bold text-orange-500">TiffinService</Link>
            <p className="text-gray-600">Fresh, homemade meals delivered to your doorstep. Experience the authentic taste of homemade food.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">info@tiffinservice.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="h-5 w-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-600">123 Food Street, City</span>
              </li>
            </ul>
          </div>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-orange-500 font-semibold mb-4">Newsletter</h3>
            <p className="text-gray-600 mb-4">Subscribe to our newsletter for updates and special offers.</p>
            <form className="flex space-x-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-2 rounded-lg bg-white border border-gray-300 text-gray-700 placeholder-gray-400 focus:outline-none focus:border-orange-500 text-sm"
              />
              <button
                type="submit"
        ...
        <div className="mt-12 pt-8 border-t border-orange-100">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-600 text-sm">
              &copy; {new Date().getFullYear()} TiffinService. All rights reserved.
            </p>
